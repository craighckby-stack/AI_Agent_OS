...
This module supports the `DiagnosticResult` pattern. All outputs are wrapped in telemetry metadata generated by `generate_telemetry_metadata` to ensure auditability within the `DiagnosticEngine` framework.